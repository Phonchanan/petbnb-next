  ...
  const loadBookings = async () => {
    try {
      ...
      if (
        ...
        if (
          current.role.toUpperCase() === 'SITTER'
        ) {
            ...
            (booking) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 border-t border-purple-50 bg-[#FAF7FE]/60 p-4 sm:flex-row sm:items-center sm:justify-between">
